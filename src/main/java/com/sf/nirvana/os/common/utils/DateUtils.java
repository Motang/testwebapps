...
public final class DateUtils {
	...
	public static String getNoSpSysDateString() {
		return DateToStr(new java.util.Date(System.currentTimeMillis()), FORMAT_DATEONLYNOSP);
	}

	public static String getSysDateString() {
		return DateToStr(new java.util.Date(System.currentTimeMillis()), DATE_FORMAT_DATEONLY);
	}
